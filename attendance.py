...
path = "C:\\Users\\DELL\\Downloads\\quantum1.jpg"
...
def TakeImages():
    ...
    if not Id and not name:
           ...
           message.configure(text = res)
           MsgBox = tk.messagebox.askquestion("Warning","Please enter College Id and Name properly , press yes if you understood",icon='warning')
           if MsgBox == 'no':
        ...
        res="Please enter Id"
        message.configure(text = res)
        MsgBox = tk.messagebox.askquestion ("Warning","Please enter College Id properly , press yes if you understood",icon = 'warning')
        if MsgBox == 'no':
            tk.messagebox.showinfo('Your need','Please go through the readme file properly')
    elif not name:
...
takeImg = tk.Button(window, text="IMAGE CAPTURE BUTTON", command=TakeImages  ,fg="black"  ,bg="skyblue"  ,width=30  ,height=3, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
takeImg.place(x=200-x_cord, y=400-y_cord)
trainImg = tk.Button(window, text="MODEL TRAINING BUTTON", command=TrainImages  ,fg="black"  ,bg="skyblue"  ,width=30 ,height=3, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
trainImg.place(x=580-x_cord, y=400-y_cord)
trackImg = tk.Button(window, text="ATTENDANCE MARKING BUTTON", command=TrackImages  ,fg="black"  ,bg="skyblue"  ,width=30  ,height=3, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
trackImg.place(x=960-x_cord, y=400-y_cord)
...
quitWindow.place(x=250, y=620-y_cord)
